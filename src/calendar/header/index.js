      ...
      >
        ...
        <View style={{display: 'flex', flexDirection: 'row', gap: 10}}>
          ...
          >
            ...
            ></View>
            <Text style={{lineHeight: 18, color: '#56504A', fontWeight: '500'}}>1단계</Text>
          </View>
          <View
            style={{
              display: 'felx',
          ...
          >
            ...
            ></View>
            <Text style={{lineHeight: 18, color: '#56504A', fontWeight: '500'}}>2단계</Text>
          </View>
          <View
            style={{
              display: 'felx',
          ...
          >
            ...
            ></View>
            <Text style={{lineHeight: 18, color: '#56504A', fontWeight: '500'}}>3단계</Text>
          </View>
        </View>
      </View>
      {renderDayNames()}
